...
class db_mysql
{
	private $host="my3521847.xincache4.cn";
	private $user="my3521847";
	private $password="s2F7Z7E6";
	private $dbName="my3521847";           //数据库名
	private $charset="utf8";          //字符编码
	private $port="3306";            //端口号
	
	public $querynum = 0 ; //当前页面进程查询数据库的次数
	public $dblink ;       //数据库连接资源
  ...
  //链接数据库
    public function connect($dbhost, $dbuser, $dbpw, $dbname='', $dbcharset='utf-8', $pconnect=0, $halt=true) {
